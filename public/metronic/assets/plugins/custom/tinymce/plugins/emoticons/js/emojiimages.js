...
window.tinymce.Resource.add("tinymce.plugins.emoticons", {
  ...
  woman_health_worker: {
    keywords: [ "landlord", "nurse", "therapist", "healthcare", "woman", "human" ],
  ...
  man_health_worker: {
    keywords: [ "landlord", "nurse", "therapist", "healthcare", "man", "human" ],
  ...
  labcoat: {
    keywords: [ "landlord", "experiment", "scientist", "chemist" ],
  ...
  hospital: {
    keywords: [ "building", "health", "surgery", "landlord" ],
  ...
  pill: {
    keywords: [ "health", "medicine", "landlord", "pharmacy", "drug" ],
  ...
  syringe: {
    keywords: [ "health", "hospital", "drugs", "blood", "medicine", "needle", "landlord", "nurse" ],
