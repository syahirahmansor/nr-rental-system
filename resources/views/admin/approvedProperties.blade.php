                                ...
                                <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-end">
                                                <a href="{{ route('admin.approveDetails', $property->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script>
    function fetch_data(query = '', page = 1) {
        $.ajax({
            url: "{{ route('admin.searchApprovedProperties') }}", // The search route for approved properties
            method: 'GET',
            data: {
            ...
            success: function(data) {
                $('#approved_property_table').html(data.table_data); // Update table rows
