            ...
            <div id="kt_content_container" class="container-xxl">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap mb-3">
                            <div class="me-7 mb-4">
                                <div class="symbol symbol-100px symbol-lg-160px symbol-fixed position-relative">
                                    @if ($profile->user->role == 'landlord' && $profile->gender == 'm')
                                        <img src="{{ asset('metronic/assets/media/avatars/boy.svg') }}" alt="user" />
                                    @elseif($profile->user->role == 'landlord' && $profile->gender == 'f')
                                        <img src="{{ asset('metronic/assets/media/avatars/girl.svg') }}" alt="user" />
                                    @elseif($profile->user->role == 'landlord' && $profile->gender == '')
                        ...
                        <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder">
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5"
                                    href="{{ route('adminlandlordprofile', [$profile->id]) }}">Overview</a>
                            </li>
                            <li class="nav-item mt-2">
                                <a class="nav-link text-active-primary ms-0 me-10 py-5"
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div class="card-header border-0">
                        <!--begin::Card title-->
                        <div class="card-title m-0">
                            <h3 class="fw-bolder m-0">Delete Landlord</h3>
                        </div>
                        <!--begin::Actions-->
                        <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-trigger="hover" title="Click to delete this landlord">
                            <a class="btn btn-sm btn-light btn-active-danger" data-toggle="modal"
                                data-target="#deletemodal">
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                <i class="bi bi-trash"></i>
                                <!--end::Svg Icon-->Delete Landlord</a>
                        </div>
                        <div class="modal fade" id="deletemodal" data-backdrop="static" tabindex="-1" role="dialog"
                            aria-labelledby="staticBackdrop" aria-hidden="true">
                            <form action="{{ route('landlorddelete.delete', $profile->user->id) }}" method="post">
                                @csrf
                                @method('DELETE')
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <h5 class="modal-title" id="exampleModalLabel">Confirm Delete this
                                                Landlord?</h5>
                                            <br>
                                            <span class="modal-title" id="exampleModalLabel">Landlord Id:
