...
@section('content')
<style>
    /* Consistent size for images and videos */
    .property-media,
    .property-video {
    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Property Details</h1>
            </div>
            <!-- Back Button -->
            <div>
                <a href="{{ route('admin.allProperties') }}" class="btn btn-secondary">
    ...
    <td colspan="3">
        ...
        @endif
                                ...
                                <div class="text-center pt-4">
                                    <button class="btn btn-primary" data-toggle="modal" data-target="#statusmodal">Take Action</button>
                                </div>
                                <!-- Include modal for update action -->
                                @include('admin.modal')
                            </div>
                        </div>
                    </div>
