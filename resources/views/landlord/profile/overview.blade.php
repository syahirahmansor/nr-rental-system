                    ...
                    <div class="card-body p-9">
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8 d-flex align-items-center">
                                <span class="fw-bolder fs-6 text-gray-800 me-2">{{ Auth::user()->landlord->phoneno }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                <span class="fw-bolder fs-6 text-gray-800">{{ Auth::user()->landlord->address }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        ...
                        <div class="row mb-7">
                            ...
                            <!--begin::Col-->
                            <div class="col-lg-8">
                                @if (Auth::user()->landlord->gender == 'm')
                                    <span class="fw-bolder fs-6 text-gray-800">Male</span>
                                @elseif (Auth::user()->landlord->gender == 'f')
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ Carbon::parse(Auth::user()->landlord->dob)->format('d F') }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
                        <!-- Begin: Row for Document -->
                         <div class="row mb-7">
                            <label class="col-lg-4 fw-bold text-muted">Deed Document</label>
                            <div class="col-lg-8">
                                @if (Auth::user()->landlord->documents->isNotEmpty())
                                ...
                                @endforeach
                                @else
                                <span class="fw-bolder fs-6 text-gray-800">No document uploaded</span>
                                @endif
                            </div>
                        </div>
                        <!-- End: Row -->
                        ...
                        <div class="row mb-7">
                            ...
                            <div class="col-lg-8">
                                <span
                                    class="fw-bolder fs-6 text-gray-800">{{ Carbon::parse(Auth::user()->landlord->created_at)->format('d F, Y') }}</span>
                            </div>
                            <!--end::Col-->
                        </div>
                        <!--end::Input group-->
