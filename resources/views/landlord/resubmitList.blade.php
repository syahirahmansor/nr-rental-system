    ...
    <div class="toolbar" id="kt_toolbar">
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Landlord Resubmission Properties</h1>
            </div>
        </div>
    </div>
    <!-- End::Toolbar -->
                    ...
                    <div class="table-responsive">
                        <table class="table table-row-dashed table-row-gray-300 align-middle gs-0 gy-4">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('landlord.resubmitPropertyDetails', $property->id) }}" class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm">
...
<script>
    function fetch_data(query = '', page = 1) {
        $.ajax({
            url: "{{ route('landlord.searchResubmitList') }}", // Adjust the route to your backend
            method: 'GET',
            data: {
                query: query,
                page: page
            ...
            success: function(data) {
                $('#resubmit_property_table').html(data.table_data);
