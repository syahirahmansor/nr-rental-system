        ...
        <div class="toolbar" id="kt_toolbar">
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                    ...
                    <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1">Resubmission Property Details</h1>
                </div>
                <!-- Back Button -->
                <div>
                    <a href="{{ route('landlord.resubmitList') }}" class="btn btn-secondary">
                                ...
                                <div class="table-responsive table-bordered table-striped">
                                    <table class="table table-bordered table-striped table-row-gray-300 align-middle gs-0 gy-4">
                                        ...
                                        <tr class="fw-bolder">
                                            ...
                                            <th class="min-w-25% text-muted">Resubmission Date</th>
                                            <td class="min-w-25%">: {{ $property->updated_at ? \Carbon\Carbon::parse($property->updated_at)->format('d-m-Y') : '-' }}</td>
                                        </tr>
                                        <tr class="fw-bolder">
                                        ...
                                        <tr class="fw-bolder">
                                            <td colspan="4" class="text-center">
                                                <!-- Use an anchor tag for navigation -->
                                                 <a href="{{ route('landlord.updateDetails', $property->id) }}" class="btn btn-primary">Update Property</a>
                                                </td>
                                            </tr>
                                    </table>
                                </div>
