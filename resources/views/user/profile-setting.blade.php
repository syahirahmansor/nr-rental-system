            ...
            <div id="kt_content_container" class="container-xxl">
                ...
                <div class="card mb-5 mb-xl-10">
                    ...
                    <div id="kt_account_profile_details" class="collapse show">
                        ...
                        action="{{ route('userprofile.update', Auth::user()->id) }}" enctype="multipart/form-data">
                            @csrf
                            @method('put')
                            <!--begin::Card body-->
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <div class="row">
                                            <!--begin::Col-->
                                            <div class="col-lg-12 fv-row">
                                                <input type="text" name="matric_number" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0" placeholder="Matric number" value="{{ Auth::user()->student->matric_number }}" disabled />
                                                @error('matric_number')
                                                <div class="text-danger">{{ $message }}</div>
                                                @enderror
                                            </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="tel" name="phoneno"
                                            ...
                                            placeholder="Phone number" value="{{ Auth::user()->student->phoneno }}" />
                                        @error('phoneno')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <textarea type="text" name="address" class="form-control form-control-lg form-control-solid"
                                            placeholder="Address">{{ Auth::user()->student->address }}</textarea>
                                        @error('address')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <select name="gender" aria-label="Select a Gender" data-control="select2"
                                            ...
                                            <option value="m"
                                                {{ Auth::user()->student->gender == 'm' ? 'selected' : '' }}>
                                                Male
                                            </option>
                                            <option value="f"
                                                {{ Auth::user()->student->gender == 'f' ? 'selected' : '' }}>
                                                Female</option>
                                            @error('gender')
                                                <div class="text-danger">{{ $message }}</div>
                                            @enderror
                                ...
                                <div class="row mb-6">
                                    ...
                                    <div class="col-lg-8 fv-row">
                                        <input type="date" name="dob"
                                            ...
                                            value="{{ \Carbon\Carbon::parse(Auth::user()->student->dob)->format('Y-m-d') }}" />
                                        @error('dob')
                                            <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
